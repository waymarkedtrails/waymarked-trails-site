...
""" Tables storing information derived from the MTB relations.
    
    The MTB cycling net is saved in Segments. A segment is strictly linear and goes from 
    ...
    Routes describe the properties of the actual MTB relations. There is one route
    per relation.
