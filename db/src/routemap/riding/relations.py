...
""" Tables storing information derived from the riding relations.
    
    The riding net is saved in Segments. A segment is strictly linear and goes from 
    ...
    Routes describe the properties of the actual riding relations. There is one route
    per relation.
...
class Routes(osgende.RelationSegmentRoutes):
    """Preprocessed information about the riding routes.
